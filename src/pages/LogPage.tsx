  ...
  return (
    <div className="space-y-4 pt-4">
      <div className="text-center">
        <h2 className="text-2xl font-semibold text-stone-800">任務紀錄📝</h2>
        <p className="text-sm text-stone-500 mt-1">回顧每一天的安排</p>
      </div>
      ...
      <SoftCard>
        <SectionHeader
          title={date === todayStr() ? '今日任務' : `${date} 的任務`}
          subtitle={`共 ${tasks.length} 項任務`}
          trailing={
            <button
        ...
        />
        {tasks.length === 0 ? (
          <p className="text-sm text-stone-400 text-center py-8">這天沒有任務 🍃</p>
        ) : (
